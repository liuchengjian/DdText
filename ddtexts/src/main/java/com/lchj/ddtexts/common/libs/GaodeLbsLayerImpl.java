package com.lchj.ddtexts.common.libs;
...
import com.lchj.ddtexts.common.utils.SensorEventHelper;
...
public class GaodeLbsLayerImpl implements ILbsLayer {
    ...
    public void setLocationRes(int res) {
        ...
        myLocationStyle.radiusFillColor(Color.argb(100, 93, 245, 255));// 设置圆形的填充颜色
...
//                mMapLocationChangeListener.onLocationChanged(aMapLocation);// 显示系统小蓝点
                Log.d(TAG, "onLocationChanged: Lat=" + aMapLocation.getLatitude() + ", Lon=" + aMapLocation.getLongitude());
